...
![](HP-MediaSmart-VGA-debug-cable-diagram2.png)
![](image-20170712_201440.jpg)
...
IF YOU WANT to just snip cables and splice/solder together, this diagram is directed at that usage.

Also, there's no reason you'd need strip back the shielding on the cable like this! But for me, it was useful to inspect the ground lines inside the vga connector -- apparently several of ground pins immediately get shorted together, and connected to just one (in this cable) ground wire that continues the length of the cable.

![](HP-MediaSmart-VGA-debug-cable-diagram1.png)
![](IMG_20170715_150233.jpg)